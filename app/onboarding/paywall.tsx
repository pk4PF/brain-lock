...
export default function PaywallScreen() {
    ...
    const plans: PlanInfo[] = [
        ...
        },
        {
            ...
            badge: 'BEST VALUE',
            pkg: annualPkg,
            price: annualPkg?.product.priceString ?? '$49.99',
        },
    ];
    ...
    const handlePurchase = async () => {
        ...
        if (!plan?.pkg) {
            if (__DEV__) {
                // Dev bypass: skip actual purchase when offerings aren't loaded
                    ...
                    {loading ? (
                        ...
                        <View style={styles.plansStack}>
                            ...
                            <Animated.View style={anim(planCardAnims[0], 16)}>
                                <TouchableOpacity
                                    style={[styles.planRow, selectedPlan === 'annual' ? styles.planRowSel : styles.planRowDefault]}
                                    onPress={() => setSelectedPlan('annual')}
                                    activeOpacity={0.8}
                                >
                                    <View style={[styles.planRadio, selectedPlan === 'annual' && styles.planRadioSel]}>
                                        {selectedPlan === 'annual' && <View style={styles.planRadioDot} />}
                                    </View>
                                    <View style={styles.planInfo}>
                                        <View style={styles.planNameRow}>
                                            <Text style={[styles.planName, selectedPlan === 'annual' && styles.planNameSel]}>Yearly</Text>
                                            <LinearGradient
                                                colors={[AMBER, '#FF8C00']}
                                                start={{ x: 0, y: 0 }}
                                                end={{ x: 1, y: 0 }}
                                    ...
                                    <View style={styles.planPriceWrap}>
                                        <Text style={[styles.planPriceMain, selectedPlan === 'annual' && styles.planPriceMainSel]}>$4.17</Text>
                            ...
                            <Animated.View style={anim(planCardAnims[1], 16)}>
                                ...
                                >
                                    ...
                                    <View style={styles.planPriceWrap}>
                                        <Text style={[styles.planPriceMain, selectedPlan === 'monthly' && styles.planPriceMainSel]}>$9.99</Text>
                                        <Text style={styles.planPricePeriod}>/mo</Text>
                                    </View>
                                </TouchableOpacity>
                            </Animated.View>
